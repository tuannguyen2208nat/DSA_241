...
string DLinkedList<T>::toString(string (*item2str)(T &)) {
  /**
   * Converts the list into a string representation, where each element is
   * formatted using a user-provided function. If no custom function is
   * provided, it directly uses the element's default string representation.
   * Example: If the list contains {1, 2, 3} and the provided function formats
   * integers, calling toString would return "[1, 2, 3]".
   *
   * @param item2str A function that converts an item of type T to a string. If
   * null, default to string conversion of T.
   * @return A string representation of the list with elements separated by
